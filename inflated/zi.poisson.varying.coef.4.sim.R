###
### Simulate zero-inflated Poisson distributed data collected in a four-level 
### hierarchy and fit model using zi.poisson.varying.coef.4.mcmc.R
###
...
source('~/Documents/git/zero/inflated/zi.poisson.varying.coef.4.mcmc.R')
