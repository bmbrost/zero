#
#
# Zero-inflated Poisson model for count data collected in three hierarchical levels
...
zi.poisson.varying.coef.3.mcmc <- function(y,X,g,priors,start,tune,adapt=TRUE,n.mcmc=1000){
