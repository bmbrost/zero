#
#
# Zero-inflated Poisson model for count data collected in four hierarchical levels
# (data, subgroup, group, and population levels), with varying coefficients at 
# the group and subgroup levels 
#
# Function name: zi.poisson.varying.coef.4.MCMC
#
...
zi.poisson.varying.coef.4.mcmc <- function(y,X,g1,g2,priors,start,tune,adapt=TRUE,n.mcmc=1000){
