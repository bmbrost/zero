###
### Simulate grouped, zero-inflated Poisson count data and 
### fit model using zi.poisson.varying.coef.3.mcmc.R
###
...
source('~/Documents/git/zero/inflated/zi.poisson.varying.coef.3.mcmc.R')
...
out1 <- zi.poisson.varying.coef.3.mcmc(y,X,g,priors,start,tune,adapt=TRUE,1000)
out1$tune
