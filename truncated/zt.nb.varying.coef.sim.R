...
### using zt.nb.varying.coef.mcmc.R
###
...
source('~/Documents/git/Multilevel/nested/negbin/zt.nb.varying.coef.mcmc.R')
...
out1 <- zt.nb.varying.coef.mcmc(z[z>0],X[z>0,],g[z>0],
	priors,start,tune,adapt=TRUE,n.mcmc=1000)
out1$tune
