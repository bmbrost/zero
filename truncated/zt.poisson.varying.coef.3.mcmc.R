#
#
# Zero-truncated Poisson model for count data collected in three hierarchical levels
# (data, group, and population levels), with varying coefficients at the group level
#
# Function name: zt.poisson.varying.coef.3.MCMC
#
...
zt.poisson.varying.coef.3.mcmc <- function(z,X,g,priors,start,tune,adapt=TRUE,n.mcmc=1000){
